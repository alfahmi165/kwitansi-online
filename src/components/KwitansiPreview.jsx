    ...
    >
      ...
      >
        ...
        <div className="flex items-end gap-2 mb-2 ml-[155px] pt-[10px]">
          <span className="text-[18px] min-w-[40px] leading-[1.2]">No.</span>
        ...
        <div className="flex items-baseline gap-4 ml-[155px] pt-[10px]">
          <span style={{ fontSize: "16px", width: "130px", flexShrink: 0 }}>Telah terima dari:</span>
          <div style={{ fontSize: "16px" }}>{data.terimaDari || ""}</div>
        </div>
        ...
        {/* Kota dan Tanggal */}
        <div className="w-fit ml-auto mr-[20px] border-b border-black flex" style={{ fontSize: "16px" }}>
          <span className="capitalize">{data.kota ? data.kota.toLowerCase() : ""}</span>
          <span>,&nbsp;</span>
